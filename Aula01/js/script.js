...
const listasDiv = document.querySelector(".listas"); // Seletor para a div que será mostrada
...
button.addEventListener("click", (event) => {
    ...
    if (inputEmailValue.length < 10 || inputEmailValue.length > 120 || parteEmail.length !== 2 || !dominios.includes(parteEmail[1])) {
    ...
    // Mostrar a div com a classe listas se estiver oculta
    if (listasDiv.style.display === 'none' || listasDiv.style.display === '') {
